...
public class StdLib {
	...
	private static Map<String, StdLibFunc> allInts() {
		...
		res.put("elementClose", slf(20, "elementClose", of(sv(NUM, 0, "id")), of()));
		res.put("elementOpenParent", slf(21, "elementOpenParent", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "parent_id"))));
		res.put("elementGetCreate", slf(22, "elementGetCreate", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "date"))));
		res.put("elementGetLastMod", slf(23, "elementGetLastMod", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "date"))));
		res.put("elementSetCreate", slf(24, "elementSetCreate", of(sv(NUM, 0, "id"), sv(NUM, 0, "date")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("elementSetLastMod", slf(25, "elementSetLastMod", of(sv(NUM, 0, "id"), sv(NUM, 0, "date")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("elementDelete", slf(26, "elementDelete", of(sv(NUM, 0, "id"), sv(NUM, 0, "force")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("elementMove", slf(27, "elementMove", of(sv(NUM, 0, "id"), sv(CHAR, 1, "newName"), sv(NUM, 0, "newParentId")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("elementGetName", slf(28, "elementGetName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "buffer")), of(sv(NUM, 0, "ignored0"), sv(CHAR, 1, "name"))));
		res.put("elementGetPath", slf(29, "elementGetPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "buffer")), of(sv(NUM, 0, "ignored0"), sv(CHAR, 1, "path"))));
		res.put("elementGetFsPath", slf(30, "elementGetFsPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "buffer")), of(sv(NUM, 0, "ignored0"), sv(CHAR, 1, "path"))));
		res.put("elementGetMount", slf(31, "elementGetMount", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "mountId"))));
		res.put("elementGetFlags", slf(32, "elementGetFlags", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "flags"))));
		res.put("elementModifyFlags", slf(33, "elementModifyFlags", of(sv(NUM, 0, "id"), sv(UDWORD, 0, "addFlags"), sv(UDWORD, 0, "remFlags")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("folderChildCount", slf(34, "folderChildCount", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childCount"))));
		res.put("folderOpenChildOfName", slf(35, "folderOpenChildOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildFolderOfName", slf(36, "folderOpenChildFolderOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildMountOfName", slf(37, "folderOpenChildMountOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildFileOfName", slf(38, "folderOpenChildFileOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildPipeOfName", slf(39, "folderOpenChildPipeOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenDescOfPath", slf(40, "folderOpenDescOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescFolderOfPath", slf(41, "folderOpenDescFolderOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescMountOfPath", slf(42, "folderOpenDescMountOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescFileOfPath", slf(43, "folderOpenDescFileOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescPipeOfPath", slf(44, "folderOpenDescPipeOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderCreateChildFolder", slf(45, "folderCreateChildFolder", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildFile", slf(46, "folderCreateChildFile", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildPipe", slf(47, "folderCreateChildPipe", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildMountTmp", slf(48, "folderCreateChildMountTmp", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name"), sv(NUM, 0, "blockCount"), sv(NUM, 0, "blockSize")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildMountIntern", slf(49, "folderCreateChildMountIntern", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name"), sv(NUM, 0, "blockCount"), sv(NUM, 0, "blockSize")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenIter", slf(50, "folderOpenIter", of(sv(NUM, 0, "id"), sv(NUM, 0, "showHidden")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "iterId"))));
		res.put("folderIterClose", slf(51, "folderIterClose", of(sv(NUM, 0, "id")), of()));
		res.put("folderIterNext", slf(52, "folderIterNext", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "child_id"))));
		res.put("fileLength", slf(53, "fileLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("fileTruncate", slf(54, "fileTruncate", of(sv(NUM, 0, "id"), sv(NUM, 0, "len")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("handleOpenStream", slf(55, "handleOpenStream", of(sv(NUM, 0, "id"), sv(UDWORD, 0, "flags")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "streamId"))));
		res.put("pipeLength", slf(56, "pipeLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("timeGet", slf(57, "timeGet", of(), of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos"), sv(NUM, 0, "success"))));
		res.put("timeRes", slf(58, "timeRes", of(), of()));
		res.put("timeSleep", slf(59, "timeSleep", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "remainSecs"), sv(NUM, 0, "remainNanos"), sv(NUM, 0, "success"))));
		res.put("timeWait", slf(60, "timeWait", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "ignored1"), sv(NUM, 0, "success"))));
		res.put("rndOpen", slf(61, "rndOpen", of(), of(sv(NUM, 0, "id"))));
		res.put("rndNum", slf(62, "rndNum", of(), of(sv(NUM, 0, "rnd"))));
		res.put("memCmp", slf(63, "memCmp", of(sv(UBYTE, 1, "memA"), sv(UBYTE, 1, "memB"), sv(NUM, 0, "len")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("memCpy", slf(64, "memCpy", of(sv(UBYTE, 1, "dstMem"), sv(UBYTE, 1, "srcMem"), sv(NUM, 0, "len")), of()));
		res.put("memMov", slf(65, "memMov", of(sv(UBYTE, 1, "srcMem"), sv(UBYTE, 1, "dstMem"), sv(NUM, 0, "len")), of()));
		res.put("memBset", slf(66, "memBset", of(sv(UBYTE, 1, "mem"), sv(UBYTE, 0, "val"), sv(NUM, 0, "len")), of()));
		res.put("strLen", slf(67, "strLen", of(sv(CHAR, 1, "str")), of(sv(NUM, 0, "len"))));
		res.put("strIndex", slf(68, "strIndex", of(sv(CHAR, 1, "str"), sv(CHAR, 0, "chr")), of(sv(NUM, 0, "index"))));
		res.put("strCmp", slf(69, "strCmp", of(sv(CHAR, 1, "strA"), sv(CHAR, 1, "strB")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("strFromNum", slf(70, "strFromNum", of(sv(NUM, 0, "val"), sv(CHAR, 1, "buf"), sv(NUM, 0, "base"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "ignored0"), sv(NUM, 0, "newBufLen"))));
		res.put("strFromFpnum", slf(71, "strFromFpnum", of(sv(FPNUM, 0, "val"), sv(CHAR, 1, "buf"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "newBufLen"))));
		res.put("strToNum", slf(72, "strToNum", of(sv(CHAR, 1, "str"), sv(NUM, 0, "base")), of(sv(NUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToFpnum", slf(73, "strToFpnum", of(sv(CHAR, 1, "str")), of(sv(FPNUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToU16str", slf(74, "strToU16str", of(sv(CHAR, 1, "u8str"), sv(UWORD, 1, "u16str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UWORD, 1, "u16strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strToU32str", slf(75, "strToU32str", of(sv(CHAR, 1, "u8str"), sv(UDWORD, 1, "u32str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UDWORD, 1, "u32strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU16str", slf(76, "strFromU16str", of(sv(UWORD, 1, "u16str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u16strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU32str", slf(77, "strFromU32str", of(sv(UWORD, 1, "u32str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u32strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFormat", slf(78, "strFormat", of(sv(CHAR, 1, "frmtStr"), sv(CHAR, 1, "outStr"), sv(NUM, 0, "bufLen"), sv(NUM, 1, "args")), of(sv(NUM, 0, "outLen"))));
		res.put("loadFile", slf(79, "loadFile", of(sv(CHAR, 1, "file")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"))));
		res.put("loadLib", slf(80, "loadLib", of(sv(CHAR, 1, "file"), sv(NUM, 0, "initOff"), sv(NUM, 0, "initIsPntr")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("createLib", slf(81, "createLib", of(sv(CHAR, 1, "file"), sv(UBYTE, 1, "mem")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("unloadLib", slf(82, "unloadLib", of(sv(UBYTE, 1, "data")), of()));
		return res;
}
