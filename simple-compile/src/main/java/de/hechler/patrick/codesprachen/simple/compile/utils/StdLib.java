...
public class StdLib {
	...
	private static Map<String, StdLibFunc> allInts() {
		...
		res.put("folderOpenChildFileOfName", slf(36, "folderOpenChildFileOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildPipeOfName", slf(37, "folderOpenChildPipeOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenDescOfPath", slf(38, "folderOpenDescOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescFolderOfPath", slf(39, "folderOpenDescFolderOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescFileOfPath", slf(40, "folderOpenDescFileOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescPipeOfPath", slf(41, "folderOpenDescPipeOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderCreateChildFolder", slf(42, "folderCreateChildFolder", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildFile", slf(43, "folderCreateChildFile", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildPipe", slf(44, "folderCreateChildPipe", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildMountTmp", slf(45, "folderCreateChildMountTmp", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name"), sv(NUM, 0, "blockCount"), sv(NUM, 0, "blockSize")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildMountIntern", slf(46, "folderCreateChildMountIntern", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name"), sv(NUM, 0, "blockCount"), sv(NUM, 0, "blockSize")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenIter", slf(47, "folderOpenIter", of(sv(NUM, 0, "id"), sv(NUM, 0, "showHidden")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "iterId"))));
		res.put("fileLength", slf(48, "fileLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("fileTruncate", slf(49, "fileTruncate", of(sv(NUM, 0, "id"), sv(NUM, 0, "len")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("handleOpenStream", slf(50, "handleOpenStream", of(sv(NUM, 0, "id"), sv(UDWORD, 0, "flags")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "streamId"))));
		res.put("pipeLength", slf(51, "pipeLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("timeGet", slf(52, "timeGet", of(), of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos"), sv(NUM, 0, "success"))));
		res.put("timeRes", slf(53, "timeRes", of(), of()));
		res.put("timeSleep", slf(54, "timeSleep", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "remainSecs"), sv(NUM, 0, "remainNanos"), sv(NUM, 0, "success"))));
		res.put("timeWait", slf(55, "timeWait", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "ignored1"), sv(NUM, 0, "success"))));
		res.put("rndOpen", slf(56, "rndOpen", of(), of(sv(NUM, 0, "id"))));
		res.put("rndNum", slf(57, "rndNum", of(), of(sv(NUM, 0, "rnd"))));
		res.put("memCmp", slf(58, "memCmp", of(sv(UBYTE, 1, "memA"), sv(UBYTE, 1, "memB"), sv(NUM, 0, "len")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("memCpy", slf(59, "memCpy", of(sv(UBYTE, 1, "dstMem"), sv(UBYTE, 1, "srcMem"), sv(NUM, 0, "len")), of()));
		res.put("memMov", slf(60, "memMov", of(sv(UBYTE, 1, "srcMem"), sv(UBYTE, 1, "dstMem"), sv(NUM, 0, "len")), of()));
		res.put("memBset", slf(61, "memBset", of(sv(UBYTE, 1, "mem"), sv(UBYTE, 0, "val"), sv(NUM, 0, "len")), of()));
		res.put("strLen", slf(62, "strLen", of(sv(CHAR, 1, "str")), of(sv(NUM, 0, "len"))));
		res.put("strIndex", slf(63, "strIndex", of(sv(CHAR, 1, "str"), sv(CHAR, 0, "chr")), of(sv(NUM, 0, "index"))));
		res.put("strCmp", slf(64, "strCmp", of(sv(CHAR, 1, "strA"), sv(CHAR, 1, "strB")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("strFromNum", slf(65, "strFromNum", of(sv(NUM, 0, "val"), sv(CHAR, 1, "buf"), sv(NUM, 0, "base"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "ignored0"), sv(NUM, 0, "newBufLen"))));
		res.put("strFromFpnum", slf(66, "strFromFpnum", of(sv(FPNUM, 0, "val"), sv(CHAR, 1, "buf"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "newBufLen"))));
		res.put("strToNum", slf(67, "strToNum", of(sv(CHAR, 1, "str"), sv(NUM, 0, "base")), of(sv(NUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToFpnum", slf(68, "strToFpnum", of(sv(CHAR, 1, "str")), of(sv(FPNUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToU16str", slf(69, "strToU16str", of(sv(CHAR, 1, "u8str"), sv(UWORD, 1, "u16str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UWORD, 1, "u16strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strToU32str", slf(70, "strToU32str", of(sv(CHAR, 1, "u8str"), sv(UDWORD, 1, "u32str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UDWORD, 1, "u32strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU16str", slf(71, "strFromU16str", of(sv(UWORD, 1, "u16str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u16strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU32str", slf(72, "strFromU32str", of(sv(UWORD, 1, "u32str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u32strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFormat", slf(73, "strFormat", of(sv(CHAR, 1, "frmtStr"), sv(CHAR, 1, "outStr"), sv(NUM, 0, "bufLen"), sv(NUM, 1, "args")), of(sv(NUM, 0, "outLen"))));
		res.put("loadFile", slf(74, "loadFile", of(sv(CHAR, 1, "file")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"))));
		res.put("loadLib", slf(75, "loadLib", of(sv(CHAR, 1, "file"), sv(NUM, 0, "initOff"), sv(NUM, 0, "initIsPntr")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("createLib", slf(76, "createLib", of(sv(CHAR, 1, "file"), sv(UBYTE, 1, "mem")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("unloadLib", slf(77, "unloadLib", of(sv(UBYTE, 1, "data")), of()));
		return res;
}
