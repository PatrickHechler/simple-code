...
public class StdLib {
	...
	private static Map<String, StdLibFunc> allInts() {
		...
		res.put("elementGetMount", slf(30, "elementGetMount", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "mount_id"))));
		...
		res.put("folderOpenDescendandOfPath", slf(38, "folderOpenDescendandOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescendandFolderOfPath", slf(39, "folderOpenDescendandFolderOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescendandFileOfPath", slf(40, "folderOpenDescendandFileOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescendandPipeOfPath", slf(41, "folderOpenDescendandPipeOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		...
		res.put("folderOpenIter", slf(45, "folderOpenIter", of(sv(NUM, 0, "id"), sv(NUM, 0, "showHidden")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "iterId"))));
		res.put("fileLength", slf(46, "fileLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("fileTruncate", slf(47, "fileTruncate", of(sv(NUM, 0, "id"), sv(NUM, 0, "len")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("handleOpenStream", slf(48, "handleOpenStream", of(sv(NUM, 0, "id"), sv(UDWORD, 0, "flags")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "streamId"))));
		res.put("pipeLength", slf(49, "pipeLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("timeGet", slf(50, "timeGet", of(), of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos"), sv(NUM, 0, "success"))));
		res.put("timeRes", slf(51, "timeRes", of(), of()));
		res.put("timeSleep", slf(52, "timeSleep", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "remainSecs"), sv(NUM, 0, "remainNanos"), sv(NUM, 0, "success"))));
		res.put("timeWait", slf(53, "timeWait", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "ignored1"), sv(NUM, 0, "success"))));
		res.put("rndOpen", slf(54, "rndOpen", of(), of(sv(NUM, 0, "id"))));
		res.put("rndNum", slf(55, "rndNum", of(), of(sv(NUM, 0, "rnd"))));
		res.put("memCmp", slf(56, "memCmp", of(sv(UBYTE, 1, "memA"), sv(UBYTE, 1, "memB"), sv(NUM, 0, "len")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("memCpy", slf(57, "memCpy", of(sv(UBYTE, 1, "dstMem"), sv(UBYTE, 1, "srcMem"), sv(NUM, 0, "len")), of()));
		res.put("memMov", slf(58, "memMov", of(sv(UBYTE, 1, "srcMem"), sv(UBYTE, 1, "dstMem"), sv(NUM, 0, "len")), of()));
		res.put("memBset", slf(59, "memBset", of(sv(UBYTE, 1, "mem"), sv(UBYTE, 0, "val"), sv(NUM, 0, "len")), of()));
		res.put("strLen", slf(60, "strLen", of(sv(CHAR, 1, "str")), of(sv(NUM, 0, "len"))));
		res.put("strIndex", slf(61, "strIndex", of(sv(CHAR, 1, "str"), sv(CHAR, 0, "chr")), of(sv(NUM, 0, "index"))));
		res.put("strCmp", slf(62, "strCmp", of(sv(CHAR, 1, "strA"), sv(CHAR, 1, "strB")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("strFromNum", slf(63, "strFromNum", of(sv(NUM, 0, "val"), sv(CHAR, 1, "buf"), sv(NUM, 0, "base"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "ignored0"), sv(NUM, 0, "newBufLen"))));
		res.put("strFromFpnum", slf(64, "strFromFpnum", of(sv(FPNUM, 0, "val"), sv(CHAR, 1, "buf"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "newBufLen"))));
		res.put("strToNum", slf(65, "strToNum", of(sv(CHAR, 1, "str"), sv(NUM, 0, "base")), of(sv(NUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToFpnum", slf(66, "strToFpnum", of(sv(CHAR, 1, "str")), of(sv(FPNUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToU16str", slf(67, "strToU16str", of(sv(CHAR, 1, "u8str"), sv(UWORD, 1, "u16str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UWORD, 1, "u16strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strToU32str", slf(68, "strToU32str", of(sv(CHAR, 1, "u8str"), sv(UDWORD, 1, "u32str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UDWORD, 1, "u32strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU16str", slf(69, "strFromU16str", of(sv(UWORD, 1, "u16str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u16strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU32str", slf(70, "strFromU32str", of(sv(UWORD, 1, "u32str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u32strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFormat", slf(71, "strFormat", of(sv(CHAR, 1, "frmtStr"), sv(CHAR, 1, "outStr"), sv(NUM, 0, "bufLen"), sv(NUM, 1, "args")), of(sv(NUM, 0, "outLen"))));
		res.put("loadFile", slf(72, "loadFile", of(sv(CHAR, 1, "file")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"))));
		res.put("loadLib", slf(73, "loadLib", of(sv(CHAR, 1, "file"), sv(NUM, 0, "initOff"), sv(NUM, 0, "initIsPntr")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("createLib", slf(74, "createLib", of(sv(CHAR, 1, "file"), sv(UBYTE, 1, "mem")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("unloadLib", slf(75, "unloadLib", of(sv(UBYTE, 1, "data")), of()));
		return res;
}
