...
public class StdLib {
	...
	private static Map<String, StdLibFunc> allInts() {
		...
		res.put("elementDelete", slf(25, "elementDelete", of(sv(NUM, 0, "id"), sv(NUM, 0, "force")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		...
		res.put("elementGetPath", slf(28, "elementGetPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "buffer")), of(sv(NUM, 0, "ignored0"), sv(CHAR, 1, "path"))));
		res.put("elementGetFsPath", slf(29, "elementGetFsPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "buffer")), of(sv(NUM, 0, "ignored0"), sv(CHAR, 1, "path"))));
		res.put("elementGetMount", slf(30, "elementGetMount", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "mountId"))));
		res.put("elementGetFlags", slf(31, "elementGetFlags", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "flags"))));
		res.put("elementModifyFlags", slf(32, "elementModifyFlags", of(sv(NUM, 0, "id"), sv(UDWORD, 0, "addFlags"), sv(UDWORD, 0, "remFlags")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("folderChildCount", slf(33, "folderChildCount", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childCount"))));
		res.put("folderOpenChildOfName", slf(34, "folderOpenChildOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildFolderOfName", slf(35, "folderOpenChildFolderOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildMountOfName", slf(36, "folderOpenChildMountOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildFileOfName", slf(37, "folderOpenChildFileOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenChildPipeOfName", slf(38, "folderOpenChildPipeOfName", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenDescOfPath", slf(39, "folderOpenDescOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "path")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescFolderOfPath", slf(40, "folderOpenDescFolderOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescMountOfPath", slf(41, "folderOpenDescMountOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescFileOfPath", slf(42, "folderOpenDescFileOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderOpenDescPipeOfPath", slf(43, "folderOpenDescPipeOfPath", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "descId"))));
		res.put("folderCreateChildFolder", slf(44, "folderCreateChildFolder", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildFile", slf(45, "folderCreateChildFile", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildPipe", slf(46, "folderCreateChildPipe", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildMountTmp", slf(47, "folderCreateChildMountTmp", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name"), sv(NUM, 0, "blockCount"), sv(NUM, 0, "blockSize")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderCreateChildMountIntern", slf(48, "folderCreateChildMountIntern", of(sv(NUM, 0, "id"), sv(CHAR, 1, "name"), sv(NUM, 0, "blockCount"), sv(NUM, 0, "blockSize")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "childId"))));
		res.put("folderOpenIter", slf(49, "folderOpenIter", of(sv(NUM, 0, "id"), sv(NUM, 0, "showHidden")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "iterId"))));
		res.put("fileLength", slf(50, "fileLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("fileTruncate", slf(51, "fileTruncate", of(sv(NUM, 0, "id"), sv(NUM, 0, "len")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "success"))));
		res.put("handleOpenStream", slf(52, "handleOpenStream", of(sv(NUM, 0, "id"), sv(UDWORD, 0, "flags")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "streamId"))));
		res.put("pipeLength", slf(53, "pipeLength", of(sv(NUM, 0, "id")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "len"))));
		res.put("timeGet", slf(54, "timeGet", of(), of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos"), sv(NUM, 0, "success"))));
		res.put("timeRes", slf(55, "timeRes", of(), of()));
		res.put("timeSleep", slf(56, "timeSleep", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "remainSecs"), sv(NUM, 0, "remainNanos"), sv(NUM, 0, "success"))));
		res.put("timeWait", slf(57, "timeWait", of(sv(NUM, 0, "secs"), sv(NUM, 0, "nanos")), of(sv(NUM, 0, "ignored0"), sv(NUM, 0, "ignored1"), sv(NUM, 0, "success"))));
		res.put("rndOpen", slf(58, "rndOpen", of(), of(sv(NUM, 0, "id"))));
		res.put("rndNum", slf(59, "rndNum", of(), of(sv(NUM, 0, "rnd"))));
		res.put("memCmp", slf(60, "memCmp", of(sv(UBYTE, 1, "memA"), sv(UBYTE, 1, "memB"), sv(NUM, 0, "len")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("memCpy", slf(61, "memCpy", of(sv(UBYTE, 1, "dstMem"), sv(UBYTE, 1, "srcMem"), sv(NUM, 0, "len")), of()));
		res.put("memMov", slf(62, "memMov", of(sv(UBYTE, 1, "srcMem"), sv(UBYTE, 1, "dstMem"), sv(NUM, 0, "len")), of()));
		res.put("memBset", slf(63, "memBset", of(sv(UBYTE, 1, "mem"), sv(UBYTE, 0, "val"), sv(NUM, 0, "len")), of()));
		res.put("strLen", slf(64, "strLen", of(sv(CHAR, 1, "str")), of(sv(NUM, 0, "len"))));
		res.put("strIndex", slf(65, "strIndex", of(sv(CHAR, 1, "str"), sv(CHAR, 0, "chr")), of(sv(NUM, 0, "index"))));
		res.put("strCmp", slf(66, "strCmp", of(sv(CHAR, 1, "strA"), sv(CHAR, 1, "strB")), of(sv(0x7L, "cmpRes")), 0x7L));
		res.put("strFromNum", slf(67, "strFromNum", of(sv(NUM, 0, "val"), sv(CHAR, 1, "buf"), sv(NUM, 0, "base"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "ignored0"), sv(NUM, 0, "newBufLen"))));
		res.put("strFromFpnum", slf(68, "strFromFpnum", of(sv(FPNUM, 0, "val"), sv(CHAR, 1, "buf"), sv(UNUM, 0, "bufLen")), of(sv(NUM, 0, "strLen"), sv(CHAR, 1, "str"), sv(NUM, 0, "newBufLen"))));
		res.put("strToNum", slf(69, "strToNum", of(sv(CHAR, 1, "str"), sv(NUM, 0, "base")), of(sv(NUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToFpnum", slf(70, "strToFpnum", of(sv(CHAR, 1, "str")), of(sv(FPNUM, 0, "val"), sv(NUM, 0, "success"))));
		res.put("strToU16str", slf(71, "strToU16str", of(sv(CHAR, 1, "u8str"), sv(UWORD, 1, "u16str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UWORD, 1, "u16strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strToU32str", slf(72, "strToU32str", of(sv(CHAR, 1, "u8str"), sv(UDWORD, 1, "u32str"), sv(NUM, 0, "bufLen")), of(sv(CHAR, 1, "u8strUnconcStart"), sv(UDWORD, 1, "u32strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU16str", slf(73, "strFromU16str", of(sv(UWORD, 1, "u16str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u16strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFromU32str", slf(74, "strFromU32str", of(sv(UWORD, 1, "u32str"), sv(CHAR, 1, "u8str"), sv(NUM, 0, "bufLen")), of(sv(UWORD, 1, "u32strUnconcStart"), sv(CHAR, 1, "u8strUnconvStart"), sv(NUM, 0, "remBufLen"), sv(NUM, 0, "remU8Len"))));
		res.put("strFormat", slf(75, "strFormat", of(sv(CHAR, 1, "frmtStr"), sv(CHAR, 1, "outStr"), sv(NUM, 0, "bufLen"), sv(NUM, 1, "args")), of(sv(NUM, 0, "outLen"))));
		res.put("loadFile", slf(76, "loadFile", of(sv(CHAR, 1, "file")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"))));
		res.put("loadLib", slf(77, "loadLib", of(sv(CHAR, 1, "file"), sv(NUM, 0, "initOff"), sv(NUM, 0, "initIsPntr")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("createLib", slf(78, "createLib", of(sv(CHAR, 1, "file"), sv(UBYTE, 1, "mem")), of(sv(UBYTE, 1, "data"), sv(NUM, 0, "len"), sv(NUM, 0, "loaded"))));
		res.put("unloadLib", slf(79, "unloadLib", of(sv(UBYTE, 1, "data")), of()));
		return res;
}
